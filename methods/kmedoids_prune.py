...
def cluster(P):
    ...
    return kmedoids(P, k+1)


def process_cluster(cluster_idx, cluster_, mappingP, mappingQ, r, i, aplha=0.8):
    """
    ...
    for idx in S:
        ...
        sensitivity_value = (2 * (r ** 1.5)) / (i**aplha)
...
# Algorithm 2: CORESET
def kmedoids_prune(P, m, max_workers=None):
    """
